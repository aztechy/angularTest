...
class CustomProductPriceTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('FIELD_ID', 'FieldId', 'INTEGER', 'fields', 'ID', true, 11, null);
    ...
    $this->addRelation('Field', 'Field', RelationMap::MANY_TO_ONE, array('field_id' => 'id', ), 'RESTRICT', 'RESTRICT');
