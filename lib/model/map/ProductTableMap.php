...
class ProductTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('PRICE', 'Price', 'DECIMAL', false, 11, 0);
	...
	{
    $this->addRelation('CustomProductPrice', 'CustomProductPrice', RelationMap::ONE_TO_MANY, array('id' => 'product_id', ), 'CASCADE', 'RESTRICT');
	} // buildRelations()
